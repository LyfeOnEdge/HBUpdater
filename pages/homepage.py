...
class homePage(cw.ThemedFrame):
	...
	def __init__(self, parent, controller,page_name,back_command):
		...
		self.nutimage = tk.PhotoImage(file=os.path.join(locations.assetfolder,"nut.png"))
		...
		# self.appstoreimage = tk.PhotoImage(file=os.path.join(locations.assetfolder, "hbappstore.png"))
		self.serialimage = tk.PhotoImage(file=os.path.join(locations.assetfolder, "serialchecker.png"))
		self.emuimage = tk.PhotoImage(file=os.path.join(locations.assetfolder, "emu.png"))
		# self.experimentalimage = tk.PhotoImage(file=os.path.join(locations.assetfolder, "experimental.png"))
		self.profileimage = tk.PhotoImage(file=os.path.join(locations.assetfolder, "profile.png"))
		self.backupsimage = tk.PhotoImage(file=os.path.join(locations.assetfolder, "backups.png"))
